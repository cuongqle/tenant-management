...
export function ProjectManager() {
  const { items, loading, error, reload } = useAsyncList(projectsApi.list);
  const { items: organizations } = useAsyncList(organizationsApi.list);
  ...
  return (
    <>
      <PageHeader
        title="Projects"
        description="All projects across organizations. Create under an organization for the usual workflow."
